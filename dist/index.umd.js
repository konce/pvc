...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('redis'), require('colors'), require('fs'), require('cli-table')) :
  typeof define === 'function' && define.amd ? define(['redis', 'colors', 'fs', 'cli-table'], factory) :
  (global.page_version_control = factory(global.Redis,global.colors,global.fs,global.Table));
}(this, (function (Redis,colors,fs,Table) { 'use strict';

Redis = 'default' in Redis ? Redis['default'] : Redis;
colors = 'default' in colors ? colors['default'] : colors;
